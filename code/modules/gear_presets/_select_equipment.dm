...
/datum/equipment_preset/proc/spawn_random_tagrilla_loadout(mob/living/carbon/human/new_human) // Randomized Tagrilla gear.
	var/random_gear = rand(0,4)
	switch(random_gear)
		if(0)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ak4047(new_human), WEAR_IN_JACKET)
		if(1)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/type71/tagrilla(new_human), WEAR_J_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type71/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type71/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type71/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type71/ap(new_human), WEAR_IN_JACKET)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type71(new_human), WEAR_IN_JACKET)
		if(2)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/smg/bizon/tagrilla(new_human), WEAR_J_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/bizon/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/bizon/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/bizon/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/bizon/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/bizon(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/bizon(new_human), WEAR_IN_JACKET)
		if(3)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/pkp(new_human), WEAR_J_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pkp(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pkp(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pkp(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pkp(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pkp(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pkp(new_human), WEAR_IN_JACKET)
		if(4)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/type24/tagrilla(new_human), WEAR_J_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type24/slug(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type24/slug(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type24(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type24(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type24/flechette(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/type24/flechette(new_human), WEAR_IN_JACKET)

// Mr. Tracksuit randoms

/datum/equipment_preset/proc/spawn_random_mr_tracksuit_loadout(mob/living/carbon/human/new_human) // Randomized Tagrilla gear.
	var/random_gear = rand(0,2)
	switch(random_gear)
		if(0)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/ak4047/tagrilla(new_human), WEAR_J_STORE)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ak4047(new_human), WEAR_IN_JACKET)
		if(1)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/ak4047_lmg/mr_tracksuit(new_human), WEAR_J_STORE)
			new_human.equip_to_slot_or_del(new/obj/item/ammo_magazine/rifle/ak4047_drum/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ak4047/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ak4047/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ak4047/ap(new_human), WEAR_IN_JACKET)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ak4047(new_human), WEAR_IN_JACKET)
